$wix = [PSCustomObject]@{
    name       = "vscode"
    exe        = "C:\Users\admin\Desktop\New folder\VSCodeSetup-x64-1.80.2.exe"
    version    = "1.80.2"
    publisher  = "letsdoautomation"
    silentArgs = "/VERYSILENT /NORESTART /SUPPRESSMSGBOXES /MERGETASKS=!runcode"
}
...
Start-Process "wix" -ArgumentList "build $(([System.IO.FileInfo]$wix.exe).Name)" -Wait -NoNewWindow -PassThru